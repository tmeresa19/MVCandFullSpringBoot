package com.tigist.mvcsavetravel.controllers;
...
import com.tigist.mvcsavetravel.services.DonationService;
...
public class HomeController {
	...
	public String processCreateForm(
		...
		//Donation newDonation = new Donation(id, donationName, ,,, ....) THe below line is enough to create it
